    ...
    <nav className="bg-[#FEC200] p-4 ">
      <div className="container  mx-auto flex flex-wrap items-center justify-between space-x-">
        ...
        <div className="flex items-center mr-9 w-full lg:w-auto lg:flex-grow lg:items-center justify-end space-x-3 ">
          ...
          {!!user && userType !== "ADMIN" && (
            <Link to="/adoption">
              <button className="mr-9 hover:bg-[#417EC5] text-black text-xl py-1 px-4 md:py-2 md:px-5 rounded-[24px]  hover:text-white transition-transform duration-200 ease-in-out transform hover:scale-90">
                Adopt
              </button>
            </Link>
          )}
                ...
                >
                  {!!user && (
                    <>
                      ...
                      <button variant="small" className="font-medium">
                        Sign Out
                      </button>
                    </>
                  )}
