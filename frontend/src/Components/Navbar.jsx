    ...
    <nav className="bg-[#FEC200] p-4 pr-5">
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div className="flex items-center w-full lg:w-auto lg:flex-grow lg:items-center mr-11 justify-end space-x-5">
          ...
          <a href="#" className="text-white mr-4 text-xl hover:bg-[#417EC5] px-4 md:py-2 md:px-5 py-1 rounded-[24px] transition-transform duration-200 ease-in-out transform hover:scale-90">Login</a>
        </div>
      </div>
    </nav>
  );
