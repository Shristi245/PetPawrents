...
from .views import UserDetailView, UserListView, TotalUsersView, UserDeleteView, TotalAppointmentsView, TotalProductsView, TotalPetsforAdoptionsView, AdoptedPetListAPIView
