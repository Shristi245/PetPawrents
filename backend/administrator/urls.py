...
from .views import UserDetailView, UserListView, TotalUsersView, UserDeleteView, TotalAppointmentsView, TotalProductsView, TotalAdoptionHistoryView
...
urlpatterns = [
    ...
    path('adoptiondetails/total/', TotalAdoptionHistoryView.as_view(), name='total_petforadoptions'),
